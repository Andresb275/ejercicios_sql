# ejercicios_sql
Ejercicios de entrenamiento sql


NOTA: En el codigo de cada ejercicio se encuentra, la explicacion de cada uno de ellos. 
Este repositorio contiene la solución al taller práctico de SQL basado en la base de datos “El Último Salto”, una tienda especializada en paracaidismo y deportes extremos.

El objetivo del taller es aplicar consultas SQL utilizando exclusivamente sentencias SELECT sobre la base de datos tienda.db, la cual está compuesta por las tablas clientes, ventas, productos y detalle_ventas.

A través de los 30 ejercicios se desarrollan consultas que permiten responder distintas preguntas de negocio, como el análisis de ventas, comportamiento de los clientes, uso de cupones de descuento, rendimiento por categoría de productos y análisis demográfico.

Cada archivo SQL incluye comentarios explicativos que describen la lógica aplicada y las funciones utilizadas en SQLite, con el propósito de que las soluciones sean claras, comprensibles y técnicamente justificadas.

Henry Andres Buesaquillo Esparza 
Esp. Big Data
